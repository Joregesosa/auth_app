    ...
    <div class='flex flex-col w-fit md:w-max m-auto'>
        ...
        <div
            ...
            <div class='max-w-[356px] flex flex-col mx-auto'>
                ...
                <h2 class='text-[#333] font-semibold text-lg w-80 my-4'>
                    Login
                </h2>
            ...
            <form action='../handles/select.php' method='POST' class='w-[356px] mx-auto'>

                <div
                    class='bg-[#FAFAFB] w-full border border-[#BDBDBD] h-12 flex items-center rounded-xl my-4 max-w-[356px]'>
                            ...
                            <defs>
                                <clipPath id='clip0_570_396'>
                                    <rect width='24' height='24' fill='white'
                                        transform='translate(0.518677 0.869141)' />
                                </clipPath>
                            </defs>
                        </svg>
                    </span>
                        ...
                        <svg xmlns='http://www.w3.org/2000/svg' width='25' height='25' viewBox='0 0 25 25' fill='none'>
                            ...
                            <defs>
                                <clipPath id='clip0_570_401'>
                                    <rect width='24' height='24' fill='white'
                                        transform='translate(0.518677 0.369141)' />
                                </clipPath>
                            </defs>
                        </svg>
                    </span>
                ...
                <p id="loginError" class="text-xs text-red-600 w-full text-center font-semibold">

                    <?= isSet($_SESSION["wrong"])? 
            ...
            <div class='w-full flex flex-col items-center justify-center mt-6 text-sm text-[#828282]'>
                        ...
                        <svg xmlns='http://www.w3.org/2000/svg' width='19' height='19' viewBox='0 0 19 19' fill='none'>
                            ...
                            <defs>
                                <clipPath id='clip0_570_412'>
                                    <rect width='18' height='17.561' fill='white'
                                        transform='translate(0.212402 0.689453)' />
                                </clipPath>
                            </defs>
                        </svg>
                            ...
                            <defs>
                                <clipPath id='clip0_570_416'>
                                    <rect width='18' height='17.9999' fill='white'
                                        transform='translate(0.51416 0.689453)' />
                                </clipPath>
                            </defs>
                        </svg>
                            ...
                            <defs>
                                <clipPath id='clip0_570_414'>
                                    <rect width='18' height='18' fill='white'
                                        transform='translate(0.0649414 0.689453)' />
                                </clipPath>
                            </defs>
                        </svg>
                ...
                Don’t have an account yet? 
                    <a href="./index.php" class='text-[#2D9CDB] cursor-pointer'>
                        Register
                    </a>
                </span>
